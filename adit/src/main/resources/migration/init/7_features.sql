...
values (1,'Процессор', 'Центральный процессор играет важнейшую роль в вычислительной системе.
    ...
    накопитель небольшого объёма.'),
       ...
       (7,'Разрешение экрана','количество пикселей'),
       (8,'Тип матрицы','Используются 3 основные технологии при изготовлении ЖК-дисплеев: TN+film, IPS и MVA.
    ...
    /*для наушников*/
        (11,'Конструкция','Существуют следующие разновидности конструкции наушников:
...
- стеклокерамика используется в стеклокерамических электрических панелях.'),
       ...
       (18,'Электрическая мощность подключения','Предельная мощность, потребляемая духовым шкафом. Ее необходимо знать, чтобы рассчитать тип электрической вилки, сечение проводов и порог срабатывания защитного автомата.'),
